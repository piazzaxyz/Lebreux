      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <a href="https://instagram.com/piazzadev" target="_blank" rel="noopener noreferrer" className="text-white/30 hover:text-[#ff3131] text-xs font-mono transition">@piazzadev</a>
          </div>
        </div>
      </div>
    </footer>
